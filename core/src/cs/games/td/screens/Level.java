...
import cs.games.td.EnemyController;
import cs.games.td.Main;
import cs.games.td.Player;
...
public abstract class Level implements Screen {
	...
	private void createStage() {
		this.stage = new Stage(new FitViewport(Main.WIDTH, Main.HEIGHT, this.camera));
		this.hudStage = new Stage(new FitViewport(Main.WIDTH, Main.HEIGHT));
		...
		topUIback.setBounds(0, Main.HEIGHT - 55, Main.WIDTH, 55);
