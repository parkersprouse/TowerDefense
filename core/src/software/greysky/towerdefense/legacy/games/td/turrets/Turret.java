...
import software.greysky.towerdefense.legacy.games.td.Enemy;
...
public abstract class Turret {
  ...
  protected int speedLevel;
    ...
    this.powerUpgradeBtn.addListener(new ClickListener() {
			public void clicked(InputEvent e, float x, float y) {
				powerUpgraded();
    ...
    this.speedUpgradeBtn.addListener(new ClickListener() {
			public void clicked(InputEvent e, float x, float y) {
				speedUpgraded();
        window.setVisible(false);
			}
  ...
  public abstract void powerUpgraded();
  public abstract void speedUpgraded();
