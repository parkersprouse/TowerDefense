...
import software.greysky.towerdefense.legacy.games.td.turrets.Cannon;
import software.greysky.towerdefense.legacy.games.td.turrets.Gun;
import software.greysky.towerdefense.legacy.games.td.turrets.Lazer;
import software.greysky.towerdefense.legacy.games.td.turrets.Turret;
...
public class TurretManager {
	...
	private void createMenuSystem() {
		...
		this.window.setBounds((TowerDefense.WIDTH/2)-(600/2), (TowerDefense.HEIGHT/2)-(600/2), 600, 600);
